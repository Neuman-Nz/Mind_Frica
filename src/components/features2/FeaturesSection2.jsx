    ...
    <div className="MainFeaturesContainer">
      <div id="carouselExampleIndicators2" class="carousel slide slideContainer">
        ...
        <div className="firstLineMap">
          ...
          <div
            className={`${indicator1 ? "flmHorizontalV1" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator2 ? "flmHorizontal2" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator4 ? "flmHorizontal1Right" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator5 ? "flmHorizontal2Right" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator1 ? "flmHorizontal1" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator2 ? "flmHorizontalV2" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator4 ? "flmHorizontalV1Right" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator5 ? "flmHorizontalV2Right" : "displayNone"}`}
          ></div>
          <div
            className={`${indicator3 ? "flmHorizontalV3Right" : "displayNone"}`}
          ></div>
          <div
        ...
        <div class="carousel-indicators slideIndicators" style={{gap: "30%"}}>
          <button
            ...
            onClick={handleInd1}
          >
            <IoLogoAndroid size={40} className="iconFeatures" color="white"/>
